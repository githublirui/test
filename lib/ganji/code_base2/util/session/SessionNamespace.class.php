 ...
 * @PURPOSE: SessionNamespace是一个静态类，对session进行统计管理
 */
class SessionNamespace {
    ...
    public static function init() {
        ...
        if (!$initFinish) {
            ...
            if( session_id() == 'deleted' ) {
                ...
                if(isset($_SERVER['HTTP_HOST']) && stripos($_SERVER['HTTP_HOST'], 'ganji.cn') !== false) {
                    setcookie(session_name(), $newId, 0, '/', '.ganji.cn');
                }
