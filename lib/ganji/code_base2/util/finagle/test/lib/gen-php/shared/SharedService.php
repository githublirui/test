...
class SharedServiceClient implements SharedServiceIf {
  ...
  {
    $args = new shared_SharedService_getStruct_args();
    $args->key = $key;
  ...
  public function recv_getStruct()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'shared_SharedService_getStruct_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new shared_SharedService_getStruct_result();
...
class shared_SharedService_getStruct_args {
  static $_TSPEC;
...
class shared_SharedService_getStruct_result {
  static $_TSPEC;
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new shared_SharedStruct();
