...
<head>
	...
	<title>解冻后台调用示例</title>
</head>
<body>

<?php
//---------------------------------------------------------
//财付通解冻后台调用示例，商户按照此文档进行开发即可
//---------------------------------------------------------
...
$reqHandler->setParameter("transaction_id", "1900000107201006240629034640");	//财付通交易单号
...
$reqHandler->setParameter("refund_id", "1091900000107201006240000101");
