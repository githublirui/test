...
$conf['font_file'] = __dir__ . '/char_inc_6.php';

//The defoult image that gets parsed when no parameter filename is given
$conf['default_image'] = __dir__ . '/CreateCode.ashx.gif';
//$conf['default_image'] = 'http://haijia.bjxueche.net/tools/CreateCode.ashx?key=ImgCode';
