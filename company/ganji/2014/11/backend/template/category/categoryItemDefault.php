        ...
        <div class="well">
            <div class="control-group">
                <div class="filter form-inline">
                    ...
                    <select name="query_categoryId" class="query_categoryId">
                        ...
                        if ($this->selectCustomer) {
                            ...
                            foreach ($categoryIds as $catId => $catArr) {
                                ?>
                                <option value="<?php echo $catId ?>" <?php if ($this->selectCategoryId == $catId) echo 'selected="selected"'; ?>><?php echo $catArr['name'] ?></option>
                                <?php
                            }
                        }
                        ?>
                    ...
                    <a id="add-item-btn" class="btn btn-success pull-right" href="/appConfManage/category/categoryItem/create"><i class="icon-plus icon-white"></i>增加条目</a>
                </div>
