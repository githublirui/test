...
//        define('URL', 'http://dev.mobds.ganjistatic3.com/users/1000140086/posts/0/2/NewPost?post_session_id=4ea310ed-37cc-41e3-83ea-26f8b7924726&major_category_script_index=2&tag=541');
        ...
        $post_fields = array(
            'action' => 'dovote',
            'guid' => '1f298e8e-c88f-2239-bf48-83cc4f6b2476',
            'ops' => '2348837',
            'wxparam' => "oTbZJt8ztIa6XiwhDnspVIvTpJgw|0f298e8e-c88f-2239-bf48-83cc4f6b2476|80b142193d43b13a9ec6a767f2748378|af1f6bfd9371ae6ad297aa53a9b7251d|vote|1481936977",
            'login_type' => 'login',
            'password' => '%B3%12%81%A0G%06%A5%7C%93%AA%B3r%F5',
        );
        $timer = new Timer();
        $timer->start();
        set_time_limit(500);
