...
include(dirname(__FILE__) . '/../src/class.upload.php');

// set variables
$dir_dest = (isset($_GET['dir']) ? $_GET['dir'] : 'H:/lirui/pan/test/company/leju/2016/3/upload/test/upload');
...
if ((isset($_POST['action']) ? $_POST['action'] : (isset($_GET['action']) ? $_GET['action'] : '')) == 'simple') {
    ...
    $handle->file_max_size = '100000';
    $handle->file_new_name_body = uniqid(mt_rand(), true);
//    $handle->allowed = array('application/vnd.ms-office','application/pdf','application/powerpoint','application/msword', 'image/*');
