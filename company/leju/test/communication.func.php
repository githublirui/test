...
$hongbao_db = array(
    'hostname' => "rds6nwjxl6758cmm0fwdxpublic.mysql.rds.aliyuncs.com",
    'username' => 'we706',
...
define('HONGBAO_MCHID', '1220658501');
define('HONGBAO_PASSWORD', 'male3652qqcomQSWHCBCOMhongbao888');
define('HONGBAO_APPID', 'wx9862b2b2638b5284');

define('HONGBAO_PROVIDER', '微信测试定向');
define('HONGBAO_WISH', '给您拜年了！');
define('HONGBAO_IP', '121.40.83.102');
define('HONGBAO_TITLE', '新年红包');
...
//    $pars['share_url'] = $_W['siteroot'].'app/' . substr(substr($this->createMobileUrl('entry', array('owner'=>$user['uid'])), 2), 0, -39);
    ...
    $xml = array2xml($pars);
    $extras = array();
    $extras['CURLOPT_CAINFO'] = './cert/rootca.pem.' . HONGBAO_UNIACID;
    $extras['CURLOPT_SSLCERT'] = './cert/apiclient_cert.pem.' . HONGBAO_UNIACID;
    $extras['CURLOPT_SSLKEY'] = './cert/apiclient_key.pem.' . HONGBAO_UNIACID;
