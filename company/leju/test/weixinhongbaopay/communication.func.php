...
define('HONGBAO_MCHID', '1273219201');
define('HONGBAO_PASSWORD', 'male3651234567weixiaozhiwangluok');
define('HONGBAO_APPID', 'wxe16c6883bae4f8a3');

define('HONGBAO_PROVIDER', '嘉乐平阳首府');
define('HONGBAO_WISH', '出租朋友圈');
define('HONGBAO_IP', '121.40.83.102');
define('HONGBAO_TITLE', '出租朋友圈');
define('HONGBAO_REMARK', '嘉乐平阳首府');
//define('HONGBAO_PROVIDER', '中旅名门府');
//define('HONGBAO_WISH', '中旅名门府给您拜年了！');
//define('HONGBAO_IP', '121.40.83.102');
//define('HONGBAO_TITLE', '中旅名门府新年红包');
//define('HONGBAO_REMARK', '分享朋友圈，邀请好友帮拆。即可收到现金红包！');
define('HONGBAO_LOGO_IMGURL', '');
define('HONGBAO_SHARE_CONTENT', '');
define('HONGBAO_SHARE_IMGURL', '');


define('HONGBAO_IP', '115.159.121.49');
...
//    $pars['share_url'] = $_W['siteroot'].'app/' . substr(substr($this->createMobileUrl('entry', array('owner'=>$user['uid'])), 2), 0, -39);
    ...
    $xml = array2xml($pars);
    $extras = array();
    $extras['CURLOPT_CAINFO'] = NOW_PATH . '/cert/rootca.pem.' . HONGBAO_UNIACID;
    $extras['CURLOPT_SSLCERT'] = NOW_PATH . '/cert/apiclient_cert.pem.' . HONGBAO_UNIACID;
    $extras['CURLOPT_SSLKEY'] = NOW_PATH . '/cert/apiclient_key.pem.' . HONGBAO_UNIACID;
