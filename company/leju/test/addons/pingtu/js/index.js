! function(e, t) {
    e("data/jigsawGame", function(e, t, n) {
        ...
        function r(e) {
            ...
            p.dom.find(".kapics").html("本关限时 "+r.second+" 秒"), u.set(f, p.currentGame), p.jigsawGame.setConfig(r)
        ...
        p.init = function(e) {
            ...
            e.html(t), p.jigsawGame = s, p.jigsawGame.init(e), p.dom = e, p.jigsawGame.on("picOver", function(e) {
				...
				document.formmessage.nickname.value=getCookie("nickname");
				document.formmessage.txtphone.value=getCookie("txtphone");
            })
