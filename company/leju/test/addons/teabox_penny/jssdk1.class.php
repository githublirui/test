...
define('APPID','wxe16c6883bae4f8a3');//设置借用appid
define('APPSN','3d07b3347632c49d84b1ca13074f05fc');//设置借用apps
...
function __construct($isjie=0,$urlx=''){
    global $_W;
   $this->appid='wxe16c6883bae4f8a3';
   $this->appsn='3d07b3347632c49d84b1ca13074f05fc';
